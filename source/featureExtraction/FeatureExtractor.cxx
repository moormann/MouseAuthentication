...
void FeatureExtractor::ExtractFrom(std::string fName){
  ...
  //CreateARF();
  //cout << "What is R value of Single Length, Double Length, speed, accel, jerk (in that order): \n";
  //cin  >> sngR >> dblR >> sR >> aR >> jR;

  //For the class assume these values
  sngR = 35;
  dblR = 200;
  sR   = 
  aR   = 
